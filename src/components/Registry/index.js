...
const RegistryPage = () => {
  return (
    <div className={cx("container",styles.wrapper)}>
      ...
      <p className="text-center col-lg-8 offset-lg-2">In consequat ipsum Lorem nisi fugiat elit elit enim amet sunt anim dolore pariatur elit. Lorem deserunt qui laboris enim consectetur dolor magna excepteur aute esse mollit qui excepteur.</p>
      <div className={cx("col-lg-10 offset-lg-1",styles.imageContainer)}>
